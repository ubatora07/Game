...
export const SETTLEMENT_RAIDS: Record<string, SettlementRaidDefinition> = {
  raid_goblin_scouts: {
    ...
    factionKey: 'raid.goblin_scouts.faction',
    descKey: 'raid.goblin_scouts.desc',
    threatLevel: 'minor',
    requiredDefense: 30,
  ...
  raid_mountain_bandits: {
    ...
    factionKey: 'raid.mountain_bandits.faction',
    descKey: 'raid.mountain_bandits.desc',
  ...
  raid_undead_horde: {
    ...
    factionKey: 'raid.undead_horde.faction',
    descKey: 'raid.undead_horde.desc',
    threatLevel: 'severe',
    requiredDefense: 160,
  ...
  raid_dragon_cultists: {
    ...
    factionKey: 'raid.dragon_cultists.faction',
    descKey: 'raid.dragon_cultists.desc',
